...
with tab_create:
    ...
    agree_ai_create = st.checkbox("Für KI-Reflexion verwenden (noch nicht implementiert)", key="ai_create", value=True)
...
with tab_edit:
    ...
    if not entries:
        ...
        agree_ai_edit = st.checkbox("Für KI-Reflexion verwenden (noch nicht implementiert)", key="ai_edit", value=True)
